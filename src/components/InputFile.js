...
import {Container, Input, Pname, Ptemp, Pdescription, Picon, Phumidity, PtempMax, 
  ...
  ThreeDaysAfter, FourDaysAfter, FiveDaysAfter, SixDaysAfter,SevenDaysAfter, Text, Icon, DailyTemp} from "./StyledComponents"
